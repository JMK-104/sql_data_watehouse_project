...
## Overview
The Gold Layer is the business-level data representation, structured to support analytical and reporting use cases. It consists of **dimension tables**(dim) and a **fact table**(fact) for specific business metrics.
