...
Script Purpose:
    ...
    that might share the same name. If one exists already, it is dropped and recreated. Additionally,
...
WARNING:
    ...
    to avoid data deletion and overwriting. Please proceed with caution and ensure your existing data is
